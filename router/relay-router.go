...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), gateway.GatewayStrategyMiddleware(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	{
		...
		wsRouter.Use(gateway.GatewayStrategyMiddleware(), middleware.Distribute())
	...
	}
	{
		...
		httpRouter.Use(gateway.GatewayStrategyMiddleware(), middleware.Distribute())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), gateway.GatewayStrategyMiddleware(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(gateway.GatewayStrategyMiddleware(), middleware.Distribute())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), gateway.GatewayStrategyMiddleware(), middleware.Distribute())
	{
